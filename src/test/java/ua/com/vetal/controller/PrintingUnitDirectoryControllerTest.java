...
public class PrintingUnitDirectoryControllerTest {
	public static final String MAPPED_URL = "/printingUnit";

	@Autowired
	private MockMvc mockMvc;
	@MockBean
	private PrintingUnitDirectoryServiceImpl mockDirectoryService;
