...
public class PrinterRepositoryTest {
	...
	public void beforeEach() {
		...
		printer = TestDataUtils.getPrinter(null, "firstName", "lastName", "middleName", "email");
	...
	public void it_should_save_Printer_with_null_fields() {
		Printer newPrinter = TestDataUtils.getPrinter(null, null, "lastName2", null, "email2");
		newPrinter = printerRepository.save(newPrinter);
		Printer foundPrinter = printerRepository.findById(newPrinter.getId()).get();
	...
	public void it_should_save_Printer_with_empty_fields() {
		Printer newPrinter = TestDataUtils.getPrinter(null, "", "lastName2", "", "email2");
		newPrinter = printerRepository.save(newPrinter);
		Printer foundPrinter = printerRepository.findById(newPrinter.getId()).get();
	...
	public void whenSavePrinterWithFirstNameTooLong_thenThrowConstraintViolationException() {
		Printer newPrinter = TestDataUtils.getPrinter(null, "FirstNameWithLengthMoreThen50SymbolsIsTooLongForSaving", "lastName2", "middleName2", "email2");
	...
	public void whenSavePrinterWithLastNameTooLong_thenThrowConstraintViolationException() {
		Printer newPrinter = TestDataUtils.getPrinter(null, "FirstName2", "lastNameWithLengthMoreThen50SymbolsIsTooLongForSaving", "middleName2", "email2");
		assertThrows(ConstraintViolationException.class, () -> {
			printerRepository.save(newPrinter);
		});
	}
	...
	public void whenSavePrinterWithLastNameTooShortLength_thenThrowConstraintViolationException() {
		Printer newPrinter = TestDataUtils.getPrinter(null, "firstName2", "", "middleName2", "email2");
		assertThrows(ConstraintViolationException.class, () -> {
			printerRepository.save(newPrinter);
		});
	}
	...
	public void whenSavePrinterWithMiddleNameTooLong_thenThrowConstraintViolationException() {
		Printer newPrinter = TestDataUtils.getPrinter(null, "FirstName", "lastName2", "middleNameWithLengthMoreThen50SymbolsIsTooLongForSaving", "email2");
		assertThrows(ConstraintViolationException.class, () -> {
			printerRepository.save(newPrinter);
		});
	}
	...
	public void whenSavePrinterWithEmailWrongLength_thenThrowConstraintViolationException() {
		Printer newPrinter = TestDataUtils.getPrinter(null, "firstName2", "lastName2", "middleName2", "EmailLengthMoreThen100SymbolsEmailLengthMoreThen100SymbolsEmailLengthMoreThen100SymbolsEmailLengthMoreThen100Symbols");
		assertThrows(ConstraintViolationException.class, () -> {
			printerRepository.save(newPrinter);
		});
	}
