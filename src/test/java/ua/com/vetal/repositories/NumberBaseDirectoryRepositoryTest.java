...
@DataJpaTest
public class NumberBaseDirectoryRepositoryTest {
    public static final String SECOND_DIRECTORY_NAME = "Second Number Base Directory";
    ...
    public static final String DIRECTORY_NAME = "NumberBaseDirectory";
    ...
    public void whenFindByName_thenReturnObject() {
        // when
        NumberBaseDirectory foundDirectory = directoryRepository.findByName(directory.getName());
    ...
    public void whenFindByID_thenReturnObject() {
        // when
        NumberBaseDirectory directory = directoryRepository.findByName(this.directory.getName());
        Optional<NumberBaseDirectory> foundDirectory = directoryRepository.findById(directory.getId());
        // then
    ...
    public void whenFindByID_thenReturnEmpty() {
        // when
        Optional<NumberBaseDirectory> foundDirectory = directoryRepository.findById(1123l);
        // then
    ...
    public void whenDeleteById_thenOk() {
        ...
        NumberBaseDirectory foundDirectory = directoryRepository.findByName(SECOND_DIRECTORY_NAME);
